<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlumbingReportDaily.aspx.cs" Inherits="TimeSheet.Reports.PlumbingReportDaily" %>
...
<body>
    ...
    <div style="text-align:center;padding-right: 10px;">
        <h2>901 Plumbing Daily Performance Report</h2>
    </div>
    ...
    <asp:GridView ID="gvReport" runat="server" CssClass="reportgrid" AutoGenerateColumns="true" AllowSorting="false" AllowPaging="false" ShowFooter="true"
        ...
        <Columns>
            <asp:BoundField DataField="ReportDate" HeaderText="Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:MM/dd/yyyy}" />
